...
st.write(
    "This is a screening tool for Attention Deficit Hyperactivity Disorder (ADHD)."
    "Please answer the following questions as honestly as possible."
)
st.write(
    "Please note that this is not a diagnostic tool. If you suspect that you "
    "or someone you know may have ADHD, please consult a medical professional."
)
